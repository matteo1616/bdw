module.exports = {
  siteTitle: "Blog du Web", // Site title.
  siteTitleShort: "BDW", // Short site title for homescreen (PWA). Preferably should be under 12 characters to prevent truncation.
  siteTitleAlt: "Blog & Web", // Alternative site title for SEO.
  siteLogo: "/logos/logo-1024.png", // Logo used for SEO and manifest.
  siteUrl: "http://localhost:8000", // Domain of your website without pathPrefix.
  pathPrefix: "https://learnsimply.alwaysdata.net/ls192x192.png", // Prefixes all links. For cases when deployed to example.github.io/gatsby-material-starter/.
